import type { Product, Shop, AffiliateDisclosure, ProductCategory } from '../components/product-recommendations/types'

export const disclosure: AffiliateDisclosure = {
  badgeLabel: 'Ad',
  disclaimerText: 'Links marked with * are affiliate links. If you purchase through these links we receive a small commission — the price for you stays the same.',
}

export const shops: Shop[] = [
  { id: 'shop-amazon', name: 'Amazon', logoUrl: '/logos/amazon.svg', affiliateTag: 'bikeweather-21' },
  { id: 'shop-bike24', name: 'Bike24', logoUrl: '/logos/bike24.svg', affiliateTag: null },
]

export const categories: ProductCategory[] = [
  { id: 'cat-jackets', name: 'Cycling Jackets', icon: 'jacket', productCount: 8 },
  { id: 'cat-gloves', name: 'Cycling Gloves', icon: 'gloves', productCount: 6 },
  { id: 'cat-pants', name: 'Cycling Tights', icon: 'pants', productCount: 5 },
  { id: 'cat-headwear', name: 'Headwear', icon: 'headwear', productCount: 4 },
  { id: 'cat-shoes', name: 'Cycling Shoes & Overshoes', icon: 'shoes', productCount: 5 },
  { id: 'cat-lights', name: 'Bike Lights', icon: 'light', productCount: 4 },
  { id: 'cat-accessories', name: 'Accessories & Gear', icon: 'accessories', productCount: 7 },
]
...
export const products: Product[] = [
  {
    ...
    imageUrl: '/products/gore-shakedry.jpg',
    price: 179.99,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    categoryId: 'cat-jackets',
    imageUrl: '/products/castelli-perfetto.jpg',
    price: 219.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    imageUrl: '/products/gripgrab-winter.jpg',
    price: 54.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    categoryId: 'cat-gloves',
    imageUrl: '/products/roeckl-illano.jpg',
    price: 34.90,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    imageUrl: '/products/assos-mille-thermo.jpg',
    price: 189.00,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    categoryId: 'cat-lights',
    imageUrl: '/products/sigma-aura80.jpg',
    price: 59.99,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    imageUrl: '/products/buff-merino.jpg',
    price: 24.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    categoryId: 'cat-pants',
    imageUrl: '/products/vaude-luminum.jpg',
    price: 99.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    imageUrl: '/products/shimano-overshoes.jpg',
    price: 69.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
  ...
  },
  {
    ...
    imageUrl: '/products/ortlieb-drybag.jpg',
    price: 14.95,
    currency: 'EUR',
    shopId: 'shop-amazon',
