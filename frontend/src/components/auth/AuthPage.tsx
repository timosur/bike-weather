...
export function AuthPage({
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (validateLogin()) onLogin?.({ ...loginForm, captchaToken: loginTurnstile.getToken() ?? undefined })
  }

  const handleRegisterSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (validateRegister()) onRegister?.({ ...registerForm, captchaToken: registerTurnstile.getToken() ?? undefined })
  }
