        ...
        <div className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-sm p-6 sm:p-8 space-y-8">
          ...
          <section id="cookies" className="space-y-2">
            ...
            <div className="text-sm text-stone-600 dark:text-stone-400 leading-relaxed space-y-2">
              ...
              <p>Google Ads are displayed to keep the app free. Google may set cookies and collect data. For more information, see <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 hover:underline">Google's Privacy Policy</a>.</p>
            </div>
          </section>
