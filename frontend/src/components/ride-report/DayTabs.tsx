      ...
      {days.map((day) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all shrink-0 ${
              isActive
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <div className="flex items-center gap-2">
                ...
                {isActive && <ConditionBadge condition={day.condition} size="sm" />}
              </div>
              {day.location && (
