...
export function mockRideReport(overrides?: Partial<{
    ...
    clothingItems: [
      {
        ...
        alternatives: [
          { id: 'cl-1-alt', name: 'Short-sleeve jersey + arm warmers', icon: 'arm-warmers' as const },
        ],
      },
      {
        id: 'cl-2',
...
export function mockMultiDayRideReport() {
  const day1 = {
    ...
    weather: {
      tempMin: 4, tempMax: 12, tempFeelsLike: 8, tempUnit: '°C',
      precipitation: 0.2, precipitationUnit: 'mm',
      windSpeed: 15, windUnit: 'km/h', windDirection: 'SW',
      humidity: 65, uvIndex: 3, sunrise: '07:15', sunset: '17:45',
      icon: 'cloud-sun' as const, description: 'Partly cloudy',
    },
    hourlyForecast: [],
    rideStartHour: 8,
    rideEndHour: 16,
    clothingItems: [
      { id: 'cl-1', name: 'Long-sleeve jersey', icon: 'jersey-long' as const, reason: 'Cool weather' },
  ...
  const day2 = {
    ...
    weather: {
      tempMin: 6, tempMax: 15, tempFeelsLike: 12, tempUnit: '°C',
      precipitation: 0, precipitationUnit: 'mm',
      windSpeed: 8, windUnit: 'km/h', windDirection: 'W',
      humidity: 50, uvIndex: 4, sunrise: '07:13', sunset: '17:47',
      icon: 'sun' as const, description: 'Sunny',
    },
    hourlyForecast: [],
    rideStartHour: 9,
    rideEndHour: 15,
