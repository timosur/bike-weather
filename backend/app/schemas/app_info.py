...
class AppInfoContentResponse(BaseModel):
    section_key: str
    title: str
    body: str
    image_url: str | None
...
class AppInfoContentCreate(BaseModel):
    sectionKey: str
    title: str
    body: str
...
class AppInfoContentUpdate(BaseModel):
...
class AppInfoContentAdminResponse(BaseModel):
    id: int
    sectionKey: str
    title: str
    body: str
    ...
    @classmethod
    def from_model(cls, obj: object) -> "AppInfoContentAdminResponse":
        return cls(
            id=getattr(obj, "id"),
