...
def get_average_speed(bike_type: str, intensity: str) -> float:
    """Return estimated average speed in km/h."""
    return _SPEED_TABLE.get((bike_type, intensity), DEFAULT_SPEED_KMH)
...
def estimate_duration_minutes(
    ...
    speed = get_average_speed(bike_type, intensity)
...
def resolve_duration_minutes(
    ...
    estimated = estimate_duration_minutes(distance_km, bike_type, intensity)
