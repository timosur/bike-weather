...
| Method | Path         | Auth | Description                                                                 |
| ------ | ------------ | ---- | --------------------------------------------------------------------------- |
| GET    | `/api/items` | 🔓    | List all recommendation item IDs with English names (for agent consumption) |
...
| GET            | `/api/admin/items`           | List recommendation items (filterable by type, zone) with parent-variant grouping |
| GET            | `/api/admin/items/{id}`      | Get single recommendation item                                                    |
| PUT            | `/api/admin/items/{id}`      | Update item metadata (names, reasons, zone, icon)                                 |
...
| Field           | Type             | Description                                                                                          |
| --------------- | ---------------- | ---------------------------------------------------------------------------------------------------- |
| `id`            | str (PK)         | Item identifier (e.g. `cl-rain-jacket`, `eq-water`)                                                  |
